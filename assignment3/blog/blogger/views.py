...
# workaround for issues with 'time' field
...
def all_posts(request):
    ...
    # Map posts to duples of (post,blurb)
    posts = map(lambda p: (p,p.post[:100] + "..."), posts)
    data = {'posts': posts}
...
def save_post(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # workaround for time not being filled in automatically
...
def save_author(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            new_author = Author(title=t, first=f, last=l)
            # Validate and save the Author
